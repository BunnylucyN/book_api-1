...
MONGO_URI = "mongodb+srv://Nepjune:<db_password>@cluster0.bsy9y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
app.config['BASIC_AUTH_USERNAME'] = 'admin'   # ตั้งค่า Username
